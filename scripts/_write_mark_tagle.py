#!/usr/bin/env python3
"""Write Mark Tagle's company from email domain (alsonspower.com = Alsons Power)."""
import json
import os
...
CID = '496452525766'
COMPANY = 'Alsons Power'

code, body = http('GET', f'https://api.hubapi.com/crm/v3/objects/contacts/{CID}?properties=company,email,firstname,lastname,jobtitle')
...
if pre and pre != '':
    ...
    code, body = http('GET', f'https://api.hubapi.com/crm/v3/objects/contacts/{CID}?properties=firstname,lastname,company,email,jobtitle')
    if code == 200:
        p = body.get('properties', {})
        print(f"\nVerify read-back:")
        ...
        print(f"  SOURCE: email domain alsonspower.com")
