#!/usr/bin/env python3
"""Write Rose Encallado's LinkedIn URL with verify-by-read-back."""
import json
import os
...
CID = '480931219144'
URL = 'https://ph.linkedin.com/in/rose-encallado-6821b9114'

# Pre-write check
code, body = http('GET', f'https://api.hubapi.com/crm/v3/objects/contacts/{CID}?properties=hs_linkedin_url')
print(f"Pre-write check: HTTP {code}, hs_linkedin_url = '{body.get('properties', {}).get('hs_linkedin_url', '')}'")
